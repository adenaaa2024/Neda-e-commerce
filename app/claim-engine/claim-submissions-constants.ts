...
/** FK to `return_items.id` — one submission row per scanner line item ready to file. */
...
export const CLAIM_SUBMISSIONS_WITH_RETURNS_EMBED = `*,return_items(${RETURNS_EMBED_SELECTOR})`;
