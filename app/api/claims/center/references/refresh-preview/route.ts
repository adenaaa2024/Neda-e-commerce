...
import {
  CenterApiError,
  getCenterReferenceRefreshPreviewPayload,
...
export async function POST(req: Request) {
  ...
  try {
    const payload = await getCenterReferenceRefreshPreviewPayload({
    ...
    const msg = e instanceof Error ? e.message : "Reference refresh preview failed.";
