 ...
 * Right: Refresh (dispatches in-app soft refresh — no router.refresh) + light/dark theme toggle.
 *
...
export function OperatorUtilityRow({ className }: { className?: string }) {
  ...
  const handleRefresh = () => {
    ...
    window.dispatchEvent(new CustomEvent("operator-mobile:request-soft-refresh"));
  };
