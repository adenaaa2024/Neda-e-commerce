-- Ensure list_workspace_organizations_for_admin references `return_items` (table rename
-- `returns` → `return_items`, migration 20260515203000). Idempotent CREATE OR REPLACE.
