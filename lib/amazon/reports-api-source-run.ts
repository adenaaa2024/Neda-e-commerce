...
// Live-source sync workers added in PHASE-AMAZON-LIVE-REPORTS-FINANCES-SYNC-WORKERS-V1:
export const SP_API_REPORT_TYPE_FBA_RETURNS =
  "GET_FBA_FULFILLMENT_CUSTOMER_RETURNS_DATA" as const;
export const SP_API_REPORT_TYPE_INVENTORY_LEDGER = "GET_LEDGER_DETAIL_VIEW_DATA" as const;
export const SP_API_REPORT_TYPE_FEE_PREVIEW =
  "GET_FBA_ESTIMATED_FBA_FEES_TXT_DATA" as const;
export const SP_API_REPORT_TYPE_INBOUND_PERFORMANCE =
  "GET_FBA_FULFILLMENT_INBOUND_PERFORMANCE_DATA" as const;
