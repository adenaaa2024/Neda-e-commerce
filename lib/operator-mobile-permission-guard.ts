...
import {
  ...
  OPERATOR_MOBILE_CLOSE_PALLET_DENIED_MESSAGE,
  OPERATOR_MOBILE_REOPEN_PALLET,
  OPERATOR_MOBILE_REOPEN_PALLET_DENIED_MESSAGE,
  OPERATOR_MOBILE_CLOSE_SHIPMENT_REVIEW,
  OPERATOR_MOBILE_CLOSE_SHIPMENT_REVIEW_DENIED_MESSAGE,
  OPERATOR_MOBILE_REOPEN_SHIPMENT_REVIEW,
  OPERATOR_MOBILE_REOPEN_SHIPMENT_REVIEW_DENIED_MESSAGE,
...
const PERMISSION_DENIED_MESSAGES: Partial<Record<OperatorMobilePermissionKey, string>> = {
  ...
  [OPERATOR_MOBILE_CLOSE_PALLET]: OPERATOR_MOBILE_CLOSE_PALLET_DENIED_MESSAGE,
  [OPERATOR_MOBILE_REOPEN_PALLET]: OPERATOR_MOBILE_REOPEN_PALLET_DENIED_MESSAGE,
  [OPERATOR_MOBILE_CLOSE_SHIPMENT_REVIEW]: OPERATOR_MOBILE_CLOSE_SHIPMENT_REVIEW_DENIED_MESSAGE,
  [OPERATOR_MOBILE_REOPEN_SHIPMENT_REVIEW]: OPERATOR_MOBILE_REOPEN_SHIPMENT_REVIEW_DENIED_MESSAGE,
};
