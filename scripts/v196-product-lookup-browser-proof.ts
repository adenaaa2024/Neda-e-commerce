 ...
 *
 * Usage:
 *   npx tsx scripts/v196-item-name-upc-ambiguous-lookup-fix.ts --run-id=20260521T220000Z
 *   npx tsx scripts/v196-item-name-upc-ambiguous-lookup-fix.ts --reuse-auth
 *   npx tsx scripts/v196-item-name-upc-ambiguous-lookup-fix.ts --manual-login --headed
 *
...
const OUT_BASE = ".cursor/audit-reports/v196-item-name-upc-ambiguous-lookup-fix";
