          ...
          {visible.map((c, i) => (
            <li key={c.name} className="cc-conditions-insight__item">
              <div className="cc-conditions-insight__row">
                ...
                <span className="cc-conditions-insight__value tabular-nums">{c.value}</span>
              </div>
              <div className="command-center-progress-track cc-conditions-insight__track">
                <div
                  className="cc-conditions-insight__fill h-full rounded-sm"
                  style={{
  ...
  return (
    <div className="command-center">
      ...
      <section aria-label="Executive summary" className="cc-executive-strip">
        ...
        <ExecGroup
          ...
          metrics={[
            {
              label: "Evidence",
              value: String(data.missingEvidence),
              warn: data.missingEvidence > 0,
            },
            {
              label: "Link gap",
              value: String(data.needsProductLink),
              warn: data.needsProductLink > 0,
            },
          ]}
          footnote={
            data.expectedItems > 0
      ...
      <section aria-label="Operational insights" className="cc-insight-row">
        <div className="cc-panel cc-insight-card">
        ...
        <div className="cc-panel cc-insight-card">
          ...
          {data.expectedItems <= 0 && data.scannedItems <= 0 ? (
            ...
            <div className="cc-scan-compact cc-scan-compact--insight">
              ...
              >
                <div
                  className="command-center-progress-fill h-full rounded-sm"
        ...
        <ConditionsInsightCard slices={data.conditionSlices} maxCondition={maxCondition} />
      </section>

      <div className="cc-body-grid">
        <section aria-label="Action queue" className="cc-panel cc-queue-panel cc-body-main">
          <header className="cc-panel__header cc-queue-header">
            ...
            <span className="cc-queue-count tabular-nums">
              {queueTotal === 0 ? "Clear" : `${queueTotal} open`}
            </span>
          </header>
        ...
        <aside className="cc-rail cc-rail--compact cc-body-rail" aria-label="Status rail">
              ...
              {linkTotal <= 0 ? (
                ...
                <div className="cc-linkage-compact cc-linkage-compact--sm">
                  ...
                  <ul className="cc-linkage-stats">
                    <li>
                      <span className="tabular-nums font-semibold text-foreground">{data.productLinkResolved}</span>
                      <span className="text-muted-foreground"> resolved</span>
                    </li>
                    <li>
                      <span className="tabular-nums font-semibold text-foreground">{data.needsProductLink}</span>
          ...
          <div className="cc-panel cc-rail-card cc-rail-card--compact">
            ...
            <div className="cc-rail-card__body cc-rail-card__body--center">
              <p className="cc-claims-ready-value cc-claims-ready-value--sm tabular-nums">{snap.claimsReadyToSend}</p>
              <p className="cc-claims-ready-label">ready_to_send</p>
              <ul className="cc-claims-mini cc-claims-mini--compact">
                <li>
                  <span>Draft</span>
                  <span className="tabular-nums font-medium">{data.claimsDraft}</span>
                </li>
                <li>
                  <span>Submitted</span>
                  <span className="tabular-nums font-medium">{data.claimFunnel.submitted}</span>
                </li>
                <li>
                  <span>Eligible</span>
                  <span className="tabular-nums font-medium">{data.claimFunnel.eligible}</span>
                </li>
              </ul>
