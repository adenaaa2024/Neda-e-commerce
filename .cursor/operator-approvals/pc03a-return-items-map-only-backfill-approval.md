...
APPROVED_PC03A_RETURN_ITEMS_MAP_ONLY_BACKFILL=false
```

## Scope

- Allowed write: UPDATE `return_items.resolved_product_id` (+ optional `product_identifier_map` gap fill) for **0** approved rows
